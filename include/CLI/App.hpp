...
class App {
  ...
  protected:
    ...
    void _process_callbacks(callback_priority priority);

    /// Run help flag processing if any are found.
    ///
    /// The flags allow recursive calls to remember if there was a help flag on a parent.
    void _process_help_flags(callback_priority priority,bool trigger_help = false, bool trigger_all_help = false) const;
