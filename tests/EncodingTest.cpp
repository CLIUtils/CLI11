...
static const std::string str(reinterpret_cast<const char *>(utf8_codeunits), std::size(utf8_codeunits));
...
static const std::wstring wstr(reinterpret_cast<const wchar_t *>(utf16_codeunits), std::size(utf16_codeunits));
...
static const std::wstring wstr(reinterpret_cast<const wchar_t *>(utf32_codeunits), std::size(utf32_codeunits));
